# Episode 001 — Status Packet

- Episode ID: YT-001
- Working title: Why Does Everyone Speak in Concepts Now?
- Repository path: `projects/youtube/001-academic-language-everyday-life/`
- Version: 0.1
- Date: 2026-09-24
...
| Stage | Artifact | State | Reason / next action |
|---|---|---|---|
...
| 10 Assembly | — | NOT_RUN | downstream |
| 11 Thumbnail | — | NOT_RUN | concept only in packaging |
| 12 Metadata | — | NOT_RUN | downstream |
| 13 Final QA | — | NOT_RUN | downstream |

## Current editorial core

The episode is **not** about “academic jargon suddenly becoming popular.”
...
1. Broaden competitor research with 2+ established English essay channels.
2. Decide whether the final episode remains four cases or uses three main cases + PUA as a short counterexample.
3. Draft the full 1,700–1,950 word English narration.
4. Re-run Evidence Gate on every spoken/on-screen claim.
5. Only then proceed to AV storyboard and production.
